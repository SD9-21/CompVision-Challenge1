...
# classes que serão contadas como veiculos
list_of_vehicles = ["car","motorbike","truck"]

# configurando o limite para o número de frames para procurar por um veículo
FRAMES_BEFORE_CURRENT = 10
inputWidth, inputHeight = 416, 416

# analisa os argumentos da linha de comando e passa os valores
LABELS, weightsPath, configPath, inputVideoPath, outputVideoPath,\
	preDefinedConfidence, preDefinedThreshold, USE_GPU= parseCommandLineArguments()

# inicializa a lista de cores para representar cada rótulo de classe possível
np.random.seed(42)
COLORS = np.random.randint(0, 255, size=(len(LABELS), 3),
	dtype="uint8")

# OBJETIVO: contagem dos veículos no canto superior esquerdo do frame
# PARAMETROS: frame no qual a contagem é demonstrada, a contagem dos veículos
# RETURN: N/A
...
# OBJETIVO: Determinar se o centróide atravessa a linha ou está dentro do alcance de 5 unidades da linha
# PARAMETROS: ponto X do centróide da bounding box, ponto Y do centróide da bounding box, coordenadas da linha
# RETURN: 
# - True se o centróide sobrepõe a linha dentro do limite de 5 unidades
# - False se o centróide está fora do limite de 5 unidades da linha
...
# OBJETIVO: Mostrar o FPS do video
# PARAMETROS: tempo do inicio do frame, número de frames dentro do mesmo segundo
# RETURN: novo tempo de inicio, novo número de frames
def displayFPS(start_time, num_frames):
	current_time = int(time.time())
	if(current_time > start_time):
		os.system('clear') # Equivalente ao CTRL+L no terminal
